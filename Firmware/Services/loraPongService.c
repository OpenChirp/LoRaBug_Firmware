/******************************************************************************
  ...
  @file  loraPongService.c

 @brief This file contains the Simple Pong sample application
...
#ifndef SERVICES_LORAPONGSERVICE_C_
#define SERVICES_LORAPONGSERVICE_C_
 ...
 * @return  None.
 */
static void LoraPong_taskFxn (UArg a0, UArg a1)
{
    Log_info0("Starting Pong Application...");
 ...
 * @return  None.
 */
void LoRaPongService_createTask(void)
{
  ...
  Task_construct(&loraPongTask, LoraPong_taskFxn, &taskParams, NULL);
}



#endif /* SERVICES_LORAPONGSERVICE_C_ */
